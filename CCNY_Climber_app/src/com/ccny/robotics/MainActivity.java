...
import com.ccny.robotics.fragment.network.INetworkFragmentInteractionListener;
import com.ccny.robotics.fragment.network.NetworkFragment;
...
// bing? implements? extends FragmentActivity?
public class MainActivity extends FragmentActivity implements INetworkFragmentInteractionListener{
	
	/*
	 * Static instance of itself.
	 */
	public static Context context; // bing? for what?
	
	// bing? what's a service?
	// Services.
	...
	private NetworkFragment networks; // bing? The type NetworkFragment is deprecated
	...
	private void initializeListeners(){
		...
		// bing? what's: new OnCheckedChangeListener() {
	...
	public void onNetworkFragmentInteraction(String name, String ip) {
		// bing? what's intent? used for what?
