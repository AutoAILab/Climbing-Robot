...
import com.ccny.robotics.job.camera.MjpegView;
import com.ccny.robotics.job.camera.TakePictureTask;
...
import com.ccny.robotics.job.car.Camera;
import com.ccny.robotics.job.car.Linino;
import com.ccny.robotics.job.ssh.SshTask;
import com.ccny.robotics.job.car.Car;
...
public class CarActivity extends FragmentActivity {
     ...
     */
    // bing? Is this the ways to start a new thread in Android Java?
    private final Runnable networkRunnable = new Runnable() {
        ...
        public void run() {
            ...
            } catch (UnknownHostException e1) { // bing? the way to handle exception
                e1.printStackTrace();
    ...
    private void initializeListeners(){
        ...
        */
        ...
        /* to make it act like turning, for safety, like: we need to hold the button to move
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                goBackward();
                return false;
     ...
     */
    private void doHonk(int speedStage){
    	send("honk" + speedStage);
    }
